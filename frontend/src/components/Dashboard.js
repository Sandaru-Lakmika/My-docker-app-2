      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div 
            ...
            className={`bg-white p-6 rounded-lg shadow-sm border cursor-pointer hover:shadow-md transition ${activeFilter === 'all' ? 'ring-2 ring-blue-500' : ''}`}
          >
            <div className="flex items-center">
          ...
          <div 
            ...
            className={`bg-white p-6 rounded-lg shadow-sm border cursor-pointer hover:shadow-md transition ${activeFilter === 'Confirmed' ? 'ring-2 ring-green-500' : ''}`}
          >
            <div className="flex items-center">
          ...
          <div 
            ...
            className={`bg-white p-6 rounded-lg shadow-sm border cursor-pointer hover:shadow-md transition ${activeFilter === 'Pending' ? 'ring-2 ring-yellow-500' : ''}`}
          >
            <div className="flex items-center">
          ...
          <div 
            ...
            className={`bg-white p-6 rounded-lg shadow-sm border cursor-pointer hover:shadow-md transition ${activeFilter === 'Completed' ? 'ring-2 ring-purple-500' : ''}`}
          >
            <div className="flex items-center">
                ...
                {filteredBookings.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="px-6 py-4 text-center text-gray-500">
                      {activeFilter === 'all' ? 'No bookings yet. Book your first service!' : `No ${activeFilter.toLowerCase()} bookings found.`}
                    </td>
                  </tr>
                ) : (
